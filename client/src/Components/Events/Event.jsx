...
function Event() {
    return (
        ...
        <section class="event-hero-detail">
            <img src="/Default_websites_for_event_designs_zoomwebnar_for_inspiration_3.jpg" alt="Tech World Conference" class="event-banner"/>
